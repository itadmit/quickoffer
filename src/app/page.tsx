...
const FAQ = [
  {
    ...
    a: "הבוט מחזיר לך הודעה נקייה עם קישור. לחיצה ארוכה, ״העבר״ (ב-WhatsApp או בטלגרם), והלקוח מקבל אותה ממך - לא ממספר זר. הוא פותח דף מעוצב מהטלפון, בלי להתקין ובלי להירשם.",
  },
  {
        ...
        <div className="relative h-[610px] rounded-[2.4rem] overflow-hidden bg-[#efe7dd] flex flex-col">
          ...
          >
            ...
            <Bubble time="10:02" delay={4450}>
              <span className="inline-flex items-center gap-1">
                <Forward className="h-3.5 w-3.5" /> להעביר ללקוח - לחיצה ארוכה ← העבר
              </span>
            </Bubble>
